...
public class HttpPostToWsFlows implements MuleTask {

    private static final String xmlTemplatePath = "httpGetToWsFlows.xml";
    private String xmlPre = "HPTW-";
    ...
    public static class Flow {
        ...
        public Flow(String listenerPath, String method, String paramType, String operation, boolean toJson, Map<String, String> map) {
    ...
    public HttpPostToWsFlows(String taskId, String listenerHost, Integer listenerPort, String wsService, String wsPort,
    ...
    public void initTask() {
        ...
        for (int i = 0; i < flows.size(); i++) {
            ...
            if (flow.paramType.equals("params")&&flow.method.equalsIgnoreCase("get")){
                StringBuilder sbParams = new StringBuilder();
                StringBuilder sbParamXml = new StringBuilder();
                for (Map.Entry<String, String> entry : flow.getMap().entrySet()) {
            ...
            }else if(flow.paramType.equals("json")&&flow.method.equalsIgnoreCase("post")){
                StringBuilder sbParams = new StringBuilder();
                StringBuilder sbParamXml = new StringBuilder();
                for (Map.Entry<String, String> entry : flow.getMap().entrySet()) {
                    sbParams.append("    <xsl:param name=\""+entry.getKey()+"\" />\n");
            ...
            }else if (flow.paramType.equals("form")&&flow.method.equalsIgnoreCase("post")){

            }else {
                LogTool.logInfo(1, "http to ws method not able to param");
                doRun = false;
            }
    ...
    public static void main(String[] args) {
        ...
        HttpPostToWsFlows httpGetToWsFlows = new HttpPostToWsFlows("hgtw-test-001", "0.0.0.0", 10086, "WBTestInterfaceImplService",
