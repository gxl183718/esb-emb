...
public class WsProxyEntity {
    ...
    private List<WsFlow> flows = new ArrayList<>();
    ...
    public List<WsFlow> getFlows() {
        return flows;
    }

    public void setFlows(List<WsFlow> flows) {
        this.flows = flows;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        WsProxyEntity httpProxyEntity1 = JSON.parseObject(task, WsProxyEntity.class);
